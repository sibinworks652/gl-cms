...
class ThemeLayout {
     ...
     constructor() {
          ...
          this.adminPreferredTheme = ['dark', 'light'].includes(window.adminPreferredTheme)
               ? window.adminPreferredTheme
               : null;
     }
     ...
     initConfig() {
          ...
          if (this.adminPreferredTheme) {
               this.config.theme = this.adminPreferredTheme;
               this.html.setAttribute('data-bs-theme', this.adminPreferredTheme);
          }
     ...
     updateThemeToggleIcon() {
          ...
          var icon = themeColorToggle.querySelector('iconify-icon');
          var isDark = this.config.theme === 'dark';

          themeColorToggle.setAttribute('title', isDark ? 'Switch to light mode' : 'Switch to dark mode');
          themeColorToggle.setAttribute('aria-label', isDark ? 'Switch to light mode' : 'Switch to dark mode');

          if (icon) {
               icon.setAttribute('icon', isDark ? 'solar:sun-bold-duotone' : 'solar:moon-bold-duotone');
          }
     }
     ...
     setSwitchFromConfig() {
          ...
          localStorage.setItem('__GL_INFOTECH_CONFIG__', JSON.stringify(this.config));
