                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="name" id="team-member-name" class="form-control @error('name') error-input-bottom @enderror" value="{{ old('name', $member->name) }}" required>
                                    @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">Slug</label>
                                    <input type="text" name="slug" id="team-member-slug" class="form-control @error('slug') error-input-bottom @enderror" value="{{ old('slug', $member->slug) }}" placeholder="john-doe">
                                    @error('slug')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Designation</label>
                                    <input type="text" name="designation" class="form-control @error('designation') error-input-bottom @enderror" value="{{ old('designation', $member->designation) }}" required>
                                    @error('designation')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Department</label>
                                    <select name="department_id" id="team-department-select" class="form-select @error('department_id') error-input-bottom @enderror">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="short_bio" rows="3" class="form-control @error('short_bio') error-input-bottom @enderror">{{ old('short_bio', $member->short_bio) }}</textarea>
                                    @error('short_bio')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Description</label>
                                    <textarea name="description" rows="7" class="form-control @error('description') error-input-bottom @enderror">{{ old('description', $member->description) }}</textarea>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') error-input-bottom @enderror" value="{{ old('email', $member->email) }}">
                                    @error('email')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Phone</label>
                                    <input type="text" name="phone" class="form-control @error('phone') error-input-bottom @enderror" value="{{ old('phone', $member->phone) }}">
                                    @error('phone')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Facebook URL</label>
                                    <input type="url" name="social_links[facebook]" class="form-control @error('social_links.facebook') error-input-bottom @enderror" value="{{ data_get($socialLinks, 'facebook') }}">
                                    @error('social_links.facebook')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Twitter / X URL</label>
                                    <input type="url" name="social_links[twitter]" class="form-control @error('social_links.twitter') error-input-bottom @enderror" value="{{ data_get($socialLinks, 'twitter') }}">
                                    @error('social_links.twitter')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">LinkedIn URL</label>
                                    <input type="url" name="social_links[linkedin]" class="form-control @error('social_links.linkedin') error-input-bottom @enderror" value="{{ data_get($socialLinks, 'linkedin') }}">
                                    @error('social_links.linkedin')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Instagram URL</label>
                                    <input type="url" name="social_links[instagram]" class="form-control @error('social_links.instagram') error-input-bottom @enderror" value="{{ data_get($socialLinks, 'instagram') }}">
                                    @error('social_links.instagram')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Website URL</label>
                                    <input type="url" name="social_links[website]" class="form-control @error('social_links.website') error-input-bottom @enderror" value="{{ data_get($socialLinks, 'website') }}">
                        ...
                        <div class="card-body">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" name="meta_title" class="form-control @error('meta_title') error-input-bottom @enderror" value="{{ old('meta_title', $member->meta_title) }}">
                                    @error('meta_title')<div class="invalid-feedback">{{ $message }}</div>@enderror
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Meta Description</label>
                                    <textarea name="meta_description" rows="4" class="form-control @error('meta_description') error-input-bottom @enderror">{{ old('meta_description', $member->meta_description) }}</textarea>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="number" name="order" class="form-control @error('order') error-input-bottom @enderror" value="{{ old('order', $member->order) }}">
