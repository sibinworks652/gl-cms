...
@section('content')
    <div class="container-xxl">
        <form method="POST" action="{{ $isEdit ? route('admin.team-departments.update', $department) : route('admin.team-departments.store') }}">
            @csrf
            @if($isEdit)
                @method('PUT')
            @endif
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
                <div>
                    <h4 class="mb-1">{{ $isEdit ? 'Edit Team Department' : 'Create Team Department' }}</h4>
                    <p class="text-muted mb-0">Create reusable groups for team pages and filters.</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.team-departments.index') }}" class="btn btn-light">Back</a>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <div class="form-check form-switch">
                                ...
                                <input class="form-check-input" type="checkbox" name="status" value="1" id="status" @checked(old('status', $department->status) == 1)>
...
document.addEventListener('DOMContentLoaded', function () {
    const nameInput = document.getElementById('team-department-name');
    const slugInput = document.getElementById('team-department-slug');
