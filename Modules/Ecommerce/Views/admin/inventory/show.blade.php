...
@section('content')
    <div class="container-xxl">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4">
            <div>
                <h4 class="mb-1">Inventory Details</h4>
                <p class="text-muted mb-0"><code>{{ $inventory->sku }}</code></p>
            </div>
            <a href="{{ route('admin.ecommerce.inventory.index') }}" class="btn btn-light">Back</a>
        </div>
        ...
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('admin.ecommerce.inventory.update', $inventory) }}">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-4">
            ...
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <div class="mb-3">
                            <div class="text-muted small">Last Restocked</div>
                            <div>{{ $inventory->last_restock_at?->format('M d, Y') ?? 'Never' }}</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="restockModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="{{ route('admin.ecommerce.inventory.restock', $inventory) }}">
                    @csrf
