                        ...
                        @forelse($products as $product)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="{{ route('admin.ecommerce.products.edit', $product) }}" class="btn btn-soft-warning btn-sm"><iconify-icon icon="solar:pen-new-square-linear" width="16" height="16"></iconify-icon></a>
