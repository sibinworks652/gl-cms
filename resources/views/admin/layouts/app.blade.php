    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function detectWithCanvas(image) {
                ...
                applyContrastBackground(image, (0.2126 * (red / count)) + (0.7152 * (green / count)) + (0.0722 * (
                    blue / count)));
            ...
            function detectLogoContrast(image) {
                try {
                    ...
                    image.style.setProperty('--auto-logo-bg',
                        'linear-gradient(135deg, #1f2937 0 50%, #f8fafc 50% 100%)');
                    image.classList.add('logo-contrast-ready');
                }
            }
