                ...
                <div class="d-flex flex-column justify-content-center">
                    <div class="auth-logo mx-auto pb-3 ">
                        <a href="{{ url('/') }}" class="logo-dark">
                            <img src="{{ $adminLoginLogo ? asset('storage/' . $adminLoginLogo) : asset('admin/assets/images/logo-sm.png') }}"
                    ...
                    <p class="text-muted mt-1 mb-2">Enter your email address or username and password to access admin
                        panel.</p>

                    <div>
                        <div id="login-alert" class="alert d-none" role="alert"></div>

                        <form method="POST" action="{{ route('login.submit') }}" class="authentication-form"
